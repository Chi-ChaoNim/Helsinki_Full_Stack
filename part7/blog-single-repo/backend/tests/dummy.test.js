...
describe("total likes", () => {
  ...
  test("when list has one blog equals the likes of that", () => {
    ...
    const results = listHelper.totalLikes(blogs);
    assert.strictEqual(results, 7);
  });

  test("when list is bigger and calculated right", () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
...
describe("favorite blog", () => {
  test("when no blogs are given", () => {
    const blog = [];
    const results = listHelper.favoriteBlog(blog);
    assert.strictEqual(results, "No blogs found");
  });

  test("when only one blog is given", () => {
    const blog = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
  ...
  test("when multiple blogs are given", () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
